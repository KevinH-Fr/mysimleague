...
class DivisionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create division" do
    assert_difference("Division.count") do
      post divisions_url, params: { division: { nom: @division.nom, numero: @division.numero } }
    end
  ...
  test "should update division" do
    patch division_url(@division), params: { division: { nom: @division.nom, numero: @division.numero } }
